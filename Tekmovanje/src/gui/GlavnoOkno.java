...
public class GlavnoOkno extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == igraClovekRacunalnik) {
			...
			Vodja.vrstaIgralca.put(Igralec.WHITE, VrstaIgralca.R1);
			Vodja.kdoIgra = new EnumMap<Igralec,KdoIgra>(Igralec.class);
			Vodja.kdoIgra.put(Igralec.BLACK, new KdoIgra("Človek")); 
			Vodja.kdoIgra.put(Igralec.WHITE, Vodja.racunalnikovaInteligenca1);
			Vodja.igramoNovoIgro();
		} else if (e.getSource() == igraRacunalnikClovek) {
			Vodja.vrstaIgralca = new EnumMap<Igralec,VrstaIgralca>(Igralec.class);
			Vodja.vrstaIgralca.put(Igralec.BLACK, VrstaIgralca.R1); 
			Vodja.vrstaIgralca.put(Igralec.WHITE, VrstaIgralca.C);
			Vodja.kdoIgra = new EnumMap<Igralec,KdoIgra>(Igralec.class);
			Vodja.kdoIgra.put(Igralec.BLACK, Vodja.racunalnikovaInteligenca1);
			Vodja.kdoIgra.put(Igralec.WHITE, new KdoIgra("Človek")); 
			Vodja.igramoNovoIgro();
			...
			Vodja.vrstaIgralca = new EnumMap<Igralec,VrstaIgralca>(Igralec.class);
			Vodja.vrstaIgralca.put(Igralec.BLACK, VrstaIgralca.R1); 
			Vodja.vrstaIgralca.put(Igralec.WHITE, VrstaIgralca.R2);
			Vodja.kdoIgra = new EnumMap<Igralec,KdoIgra>(Igralec.class);
			Vodja.kdoIgra.put(Igralec.BLACK, Vodja.racunalnikovaInteligenca1);
			Vodja.kdoIgra.put(Igralec.WHITE, Vodja.racunalnikovaInteligenca2); 
			Vodja.igramoNovoIgro();
		}
	}
		...
		if (Vodja.igra == null) {
			...
			case V_TEKU: 
				status.setText("Na potezi je " + Vodja.igra.naPotezi() + 
						" - " + Vodja.kdoIgra.get(Vodja.igra.naPotezi()).toString()); 
				break;
			case ZMAGA_B: 
				status.setText("Zmagal je crni - " + 
						Vodja.kdoIgra.get(Vodja.igra.naPotezi().nasprotnik()).toString());
				break;
			case ZMAGA_W: 
